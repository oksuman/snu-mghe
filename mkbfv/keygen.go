...
func (keygen *KeyGenerator) GenRelinearizationKey(sk *mkrlwe.SecretKey) (rlk *RelinearizationKey) {
...
func (keygen *KeyGenerator) GenGroupRelinKey(rlkList []*RelinearizationKey) (rlkOut *RelinearizationKey) {
	...
	for _, rlk := range rlkList {
		...
		for i := 0; i < beta; i++ {
			rlk0 := rlk.Value[0]
			rlkOut0 := rlkOut.Value[0]

			params.RingQP().AddLvl(levelQ, levelP, rlk0.Value[0].Value[i], rlkOut0.Value[0].Value[i], rlkOut0.Value[0].Value[i])
			params.RingQP().AddLvl(levelQ, levelP, rlk0.Value[1].Value[i], rlkOut0.Value[1].Value[i], rlkOut0.Value[1].Value[i])
			params.RingQP().AddLvl(levelQ, levelP, rlk0.Value[2].Value[i], rlkOut0.Value[2].Value[i], rlkOut0.Value[2].Value[i])

			rlk1 := rlk.Value[1]
			rlkOut1 := rlkOut.Value[1]

			params.RingQP().AddLvl(levelQ, levelP, rlk1.Value[0].Value[i], rlkOut1.Value[0].Value[i], rlkOut1.Value[0].Value[i])
			params.RingQP().AddLvl(levelQ, levelP, rlk1.Value[1].Value[i], rlkOut1.Value[1].Value[i], rlkOut1.Value[1].Value[i])
		}
	}
